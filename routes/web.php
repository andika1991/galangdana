...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('admin')->name('admin.')->group(function () {
        ...
        Route::post('/fundraising_withdrawals/request/{fundraising}', 
            [FundraiserController::class, 'store']
        )->middleware('role:fundraiser')->name('fundraisingwithdrawal.store');

  

        Route::post('/fundraisings/active/{fundraising}', 
            [FundraisingController::class, 'activate_fundraising']
        ...
        Route::resource('fundraising_withdrawals', FundraisingWithdrawalController::class)
            ...
            Route::post('/fundraisiung_withdrawals/{fundraising}', 
        ...
        Route::resource('fundraising_phases', FundraisingPhaseController::class)
            ...
            Route::post('/fundraising_phases/update/{fundraising}', 
        ...
        Route::get('/my-withdrawals/details/{fundraisingWithdrawal}',[DashboardController::class,'my_withdrawals_details'])->name('my_withdrawal.details');
    }); 
});
