    ...
    <section class="max-w-[640px] w-full min-h-screen mx-auto flex flex-col bg-[#FCF7F1] overflow-x-hidden">
        ...
        <div class="flex flex-col z-30">
            <div id="content" class="w-full min-h-[calc(100vh-220px)] h-full bg-white rounded-t-[40px] flex flex-col gap-5 p-[30px_24px_30px]">
                <form method="POST" action="{{route('front.store',['fundraising'=>$fundraising->slug,'totalAmountDonation'=>$totalAmountDonation])}}"enctype="multipart/form-data" class="flex flex-col gap-5">
                    @csrf
                            ...
                            <div id="accordion-faq-1" class="accordion-content open">
                                <div class="pt-3 flex flex-col gap-3">
                                    ...
                                    <div class="flex items-center justify-between">
                                        ...
                                        <span class="font-semibold text-sm">Andika Fikri Azhri</span>
                    ...
                    <div class="flex flex-col gap-[10px]">
                        <p class="font-semibold text-sm">Notes (Optional)</p>
                        <div class="flex items-center w-full p-[14px_16px] rounded-2xl border border-[#E8E9EE] focus-within:border-[#292E4B] transition-all duration-300">
                            <div class="mr-[10px] w-6 h-6 flex items-center justify-center overflow-hidden">
                                <img src="{{ asset('assets/images/icons/note.svg') }}" class="h-full w-full object-contain" alt="icon">
                            </div>
                            <textarea class="font-semibold placeholder:text-[#292E4B] placeholder:font-normal w-full outline-none resize-none" placeholder="Add a note (optional)" name="notes"></textarea>
                        </div>
                    </div>
