<x-app-layout>
    ...
    <div class="py-12">
        ...
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            ...
            <span class="text-white font-bold bg-green-500 rounded-2xl w-fit p-10">
                Fundraising telah aktif & dapat menerima donasi
               </span>
            @else
                <div class="flex flex-row justify-between">
                <span class="text-white font-bold bg-red-500 rounded-2xl w-fit p-10">
                Fundraising belum disetujui Admin
               </span>
               @role('owner')
            ...
            @endif
                ...
                <div class="flex flex-row justify-between items-center">
                    <div>
                        <h3 class="text-indigo-950 text-xl font-bold">Rp {{ number_format($totalDonations, 0, ',', '.') }}
                        </h3>
