    ...
    <div class="py-12">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg p-10 flex flex-col gap-y-5">
                ...
                <div class="flex flex-row gap-x-16">
                    ...
                    <div class="flex flex-col gap-y-10">    
                        ...
                        <span class="w-fit text-sm font-bold py-2 px-3 rounded-full bg-orange-500 text-white">
                            PENDING
                        </span> <span class="w-fit text-sm font-bold py-2 px-3 rounded-full bg-green-500 text-white">
                            SUCCESS
                        </span>
                        @else
                        ...
                        <div>
                            ...
                            <h3 class="text-indigo-950 text-xl font-bold">{{ \Carbon\Carbon::parse($FundraisingWithdrawal->created_at)->format('d M Y') }}</h3>
                        </div>
                        <div class="">
                ...
                <hr class="my-5">
                @if(!$FundraisingWithdrawal->has_set)
                <h3 class="text-indigo-950 text-xl font-bold mb-5">Belum diproses</h3>
                @else
